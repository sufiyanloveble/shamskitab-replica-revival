...
import { Truck, CreditCard, BookOpen, RotateCcw } from "lucide-react";
...
const CustomerPerks = () => {
  const perks = [
    ...
    {
      icon: <RotateCcw size={24} className="text-islamic-green" />,
      title: "30-Day Return Guarantee",
      description: "Easy returns if you're not satisfied"
    }
  ];
